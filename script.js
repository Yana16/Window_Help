...
let discount = (modalState, globalState) => {
  ...
  function discountTimer(timer) {
    ...
    jQuery("#discount1").attr("placeholder", disc.toFixed(2)).val(disc.toFixed(2));
    jQuery("#discount2").attr("placeholder", disc.toFixed(2)).val(disc.toFixed(2));
    jQuery("#discount").attr("placeholder", disc.toFixed(2)).val(disc.toFixed(2));
...
const forms = modalState => {
  ...
  forma.forEach(item => {
    item.addEventListener("submit", e => {
      ...
      postData("app/js", formData).then(res => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initRatings: () => (/* binding */ initRatings)
/* harmony export */ });
//Основная функция
...
jQuery(".form-control1").mask("+38 (999) 999-99-99");
...
module.exports = "document" in __webpack_require__.g ? __webpack_require__(/*! ./finder */ "./node_modules/slick/finder.js") : { parse: __webpack_require__(/*! ./parser */ "./node_modules/slick/parser.js") }
...
/* harmony import */ var _phone_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./phone.js */ "./src/js/phone.js");
/* harmony import */ var _phone_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_phone_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _fotorama_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fotorama.js */ "./src/js/fotorama.js");
/* harmony import */ var _fotorama_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_fotorama_js__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _discount_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./discount.js */ "./src/js/discount.js");
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_modals_js__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState, globalState);
  (0,_discount_js__WEBPACK_IMPORTED_MODULE_6__["default"])(modalState, globalState);
  let deadLine = "2024-05-16";

  // forms(modalState, globalState);

  (0,_modules_timer_js__WEBPACK_IMPORTED_MODULE_7__["default"])(".container1", deadLine);
  (0,_modules_rating_js__WEBPACK_IMPORTED_MODULE_10__.initRatings)();
  (0,_modules_telegram_js__WEBPACK_IMPORTED_MODULE_8__["default"])();
  (0,_modules_discountTab_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
});
})();
